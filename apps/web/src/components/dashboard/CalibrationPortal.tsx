...
export const CalibrationPortal = ({ userId }: { userId: string }) => {
  ...
  if (loading) return (
    <div className="flex items-center gap-3 py-12">
      <Logo size={12} className="text-violet-400 animate-spin" />
      <span className="text-white/20 text-[10px] uppercase tracking-widest font-mono">Scanning Neural Archive...</span>
    </div>
  );
