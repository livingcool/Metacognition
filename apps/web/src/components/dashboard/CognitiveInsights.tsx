  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-12">
        ...
        <Brain className="text-violet-500/30 w-8 h-8 group-hover:text-violet-400 group-hover:scale-110 transition-all duration-700" />
      </div>
      ...
      <div className="mt-12 pt-8 border-t border-white/5 flex items-center gap-4 text-[9px] font-mono text-slate-600 uppercase tracking-widest">
         <Info size={12} className="text-indigo-400 opacity-50" />
