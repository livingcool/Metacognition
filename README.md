<div align="center">
  <img src="https://via.placeholder.com/150/09090b/a78bfa?text=Mirror+AI" alt="Mirror AI Logo" width="150" height="150" style="border-radius: 50%; box-shadow: 0 0 20px rgba(167, 139, 250, 0.4);" />

  # Mirror AI: The Metacognitive Protocol (v4.0)

  **The final frontier is not space, but the neural architecture of the observer.**

  [![Hackathon](https://img.shields.io/badge/Hackathon-Winner_Tier-a78bfa?style=for-the-badge&logo=hackthebox)](https://mirror-ai.vercel.app)
  [![Vercel](https://img.shields.io/badge/Vercel-Deployed-000000?style=for-the-badge&logo=vercel)](https://vercel.com)
  [![TypeScript](https://img.shields.io/badge/TypeScript-Strict-3178C6?style=for-the-badge&logo=typescript)](https://www.typescriptlang.org/)
  [![Gemini](https://img.shields.io/badge/Gemini_2.5_Flash-Powered-1A73E8?style=for-the-badge&logo=google)](https://ai.google.dev/)
...
sequenceDiagram
    ...
    participant AI (Gemini 2.5 Flash)
    participant DB (Supabase pgvector)

    User->>Web: Audio/Text Input
    Web->>API: POST /api/session/:id/message
    activate API
    API->>DB: Fetch Cognitive Profile & Recent Sessions
    DB-->>API: Profile + Biases + Timeline
    API->>DB: Vector Similarity Search (RAG)
    DB-->>API: Historical Neural Cues
    API->>AI: PIVOT Prompt + Context + New Input
    activate AI
    AI-->>API: Stream JSON (Reflection, Question, DNA, Choices)
    deactivate AI
    API-->>Web: Server-Sent Events (SSE) Stream
    Web->>User: Real-time UI Update (Voice/Text/Orb)
    API->>DB: Async Write Message & Update Radar Stats
    deactivate API
```
